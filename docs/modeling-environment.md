...
## SysML v2 Modeling Environment and Tools


This page provides instruction to help with setting up your own SysML v2 textual notation model development environment. It also provides vendor modeling tool information.

*Content derived from OUSD (R&E) publicly available material*

### SysML v2 Modeling Environment Setup Information
...
#### SysML v2 Tool Vendor Information

SysML v2 Tool Vendor Roadmap Information: [INCOSE 2024 International Workshop (IW), SysML v2 Vendor Roadmaps](workshops/iw-2024.md)

Tool Vendor Capability Matrix:
[SysMLv2 Tool Capability Summary](tool-capability-summary.md)
